...
const products = [
    { name: 'Classic White Shirt', category: ['men', 'summer', 'sale'], price: 49.99, size: 'M', img: 'https://images.unsplash.com/photo-1583743814966-8936f970b74b?auto=format&fit=crop&w=500&q=60' },
    { name: 'Denim Jacket', category: ['men', 'urban'], price: 89.99, size: 'L', img: 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?auto=format&fit=crop&w=500&q=60' },
    { name: 'Floral Dress', category: ['women', 'festive'], price: 69.99, size: 'S', img: 'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?auto=format&fit=crop&w=500&q=60' },
    { name: 'Chinos', category: ['men', 'urban', 'sale'], price: 59.99, size: 'XL', img: 'https://images.unsplash.com/photo-1618371518539-e2601d1a3b7d?auto=format&fit=crop&w=500&q=60' }
];
...
function filterProducts() {
    ...
    const filteredProducts = products.filter(product => {
        const categoryMatch = category === 'all' || product.category.includes(category);
        let priceMatch = true;
        if (price !== 'all') {
...
// Apply category filter and scroll to shop section
...
function showPage(page) {
    ...
    // In a real application, this could load a new section or page
}

// Initialize Vanilla Tilt and carousel
